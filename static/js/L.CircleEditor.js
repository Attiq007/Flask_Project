...
L.CircleEditor = L.Circle.extend ({
    ...
    _createMarker: function (latlng, index, isCenter) {
        var marker = new L.Marker(latlng, {
            draggable: true, // This option stills both center and resizable point
        ...
        //This works by commenting Circle stays But center point changes its position
        if (isCenter) {
    ...
    _onMarkerDrag: function (e) {
        ...
        var distance = center.distanceTo(axis); // That gives us the radius size

        this.setRadius(distance);

        //console.log(distance); Check for myself
